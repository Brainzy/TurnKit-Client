        ...
        private static string GetApplicationPath()
        {
            ...
            switch (Application.platform)
            {
                case RuntimePlatform.WindowsEditor:
                    return string.IsNullOrEmpty(currentProcessPath) ? EditorApplication.applicationPath : currentProcessPath;
                case RuntimePlatform.OSXEditor:
                    return string.IsNullOrEmpty(currentProcessPath)
                        ? EditorApplication.applicationPath + "/Contents/MacOS/Unity"
                        : currentProcessPath;
